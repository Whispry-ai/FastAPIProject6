#!/usr/bin/env python3
"""
Create user with exactly 7 values (no is_active)
"""
...
def create_user():
    """Create user with exactly 7 values"""
    print("👤 Creating user...")
    ...
    try:
        ...
        cursor.execute("""
            ...
            VALUES (?, ?, ?, ?, ?, ?)
        """, (user_uid, "kamineniaswini@gmail.com", "+7601002908", "Admin User", 5, datetime.now()))
...
def main():
    print("🚀 Create User (Final Working)")
    print("=" * 50)
