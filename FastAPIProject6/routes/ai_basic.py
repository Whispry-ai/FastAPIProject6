"""
Basic AI Routes for Hyperlocal News Application
Simple, working endpoints that will definitely work
"""
...
async def sentiment_analysis(
    ...
    try:
        ...
        positive_words = ["good", "great", "excellent", "amazing", "wonderful", "fantastic", "positive", "success", "thriving", "beautiful"]
...
async def fake_news_detection(
    ...
    try:
        ...
        clickbait_words = ["shocking", "unbelievable", "miracle", "secret", "revealed", "never before seen"]
...
"Local School Wins Award","The local school has won regional education award for excellence","John Doe","2024-01-15"
