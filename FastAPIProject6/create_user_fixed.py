#!/usr/bin/env python3
"""
Create user with correct column count
"""
...
def create_user():
    ...
    try:
        ...
        cursor.execute("""
            ...
            (user_uid, email, phone, name, role, created_at, is_active, email_verified, mobile_verified, token_version)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        """, (user_uid, "kamineniaswini@gmail.com", "+7601002908", "Admin User", 5, datetime.now(), 1, 1, 1, 0))
