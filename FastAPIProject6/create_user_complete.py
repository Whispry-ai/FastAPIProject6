#!/usr/bin/env python3
"""
Create complete user with both phone and email
"""
...
def create_complete_user():
    ...
    try:
        ...
        cursor.execute("""
            ...
            (user_uid, email, phone, name, role, created_at, is_active, email_verified, mobile_verified)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        """, (user_uid, "kamineniaswini@gmail.com", "+7601002908", "Admin User", 5, datetime.now(), 1, 1, 1))
...
def main():
    print("🚀 Create Complete User (Email + Phone)")
    print("=" * 50)
    
    if create_complete_user():
        print("\n" + "=" * 50)
