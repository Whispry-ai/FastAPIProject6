#!/usr/bin/env python3
"""
Create publisher user with correct column count
"""
...
def create_publisher_user():
    """Create publisher user with correct columns"""
    ...
    try:
        ...
        # Create publisher user with exactly 5 columns (user_uid, email, phone, name, role, created_at)
...
def main():
    print("🚀 Create Publisher User (Final)")
    print("=" * 50)
